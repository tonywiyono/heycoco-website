...
type SidebarCtaLinkProps = {
  cta: SidebarCta;
};

export function SidebarCtaLink({ cta }: SidebarCtaLinkProps) {
  if (!cta.enabled) return null;

  const style = {
    "--cta-bg": cta.backgroundColor,
    "--cta-bg-hover": cta.hoverBackgroundColor,
    "--cta-text": cta.textColor,
  } as CSSProperties;
