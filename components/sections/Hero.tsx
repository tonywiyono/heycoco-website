    ...
    <Section id="home" title="Home" className="mb-4 max-lg:mb-3">
      <div className="grid gap-3 sm:gap-4 lg:grid-cols-12 lg:grid-rows-2 lg:min-h-[calc(100dvh-5rem)]">
        <BentoCard
          variant="dark"
          hover={false}
          className="relative flex h-[calc(100dvh-4rem-1rem)] min-h-[360px] flex-col justify-between overflow-hidden p-6 sm:min-h-[420px] sm:p-10 lg:col-span-9 lg:row-span-2 lg:h-full lg:min-h-0"
        >
